...
- validate input for a yes/no prompt,
- validate user email and password input,
- create and return BufferedReader and BufferedWriter objects,
- initialize the database,
- initialize the collections,
- read and write data from FireStore,
- and converting FireStore data to an Array.
