...
public class TestUtils {
    ...
    public void setUp() {
        ...
        customers.add(Map.of("cartId", 0, "customerId", 0, "email", "adityasemail@gmail.com", "password", "password",
                "productIds", Arrays.asList(0)));
        customers.add(Map.of("cartId", 1, "customerId", 1, "email", "shloksemail@gmail.com", "password", "password",
                "productIds", Arrays.asList()));
        customers.add(Map.of("cartId", 2, "customerId", 2, "email", "xandersemail@gmail.com", "password", "password",
        ...
        stores.add(Map.of("customerIds", Arrays.asList(0), "name", "Goodreads", "productIds", Arrays.asList(0, 1),
                "storeId", 0));
        ...
        sellers.add(
                Map.of("email", "rickriordan@gmail.com", "name", "Rick Riordan", "password", "lightning", "productIds",
                        Arrays.asList(0), "saleIds", Arrays.asList(0),
                        "sellerId", 0));
        sellers.add(Map.of("email", "jkrowling@gmail.com", "name", "JK Rowling", "password", "magic", "productIds",
        ...
        sellers.add(Map.of("email", "ceat@gmail.com", "name", "Ceat", "password", "magic", "cricket",
                ...
                "sellerId", 2));
        sellers.add(Map.of("email", "nintendo@nintendo.com", "name", "Nintendo", "password", "wahoo", "productIds",
