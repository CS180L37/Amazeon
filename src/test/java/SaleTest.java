...
//        assertEquals(1,
//                Utils.retrieveData(sales.whereEqualTo("customerId", "50").limit(1).get()).size());
//    }
//
//    @Test
...
//        assertEquals(1,
//                Utils.retrieveData(sales.whereEqualTo("productId", 5).limit(1).get()).size());
//    }
//
//    @Test
...
//        assertEquals(1,
//                Utils.retrieveData(sales.whereEqualTo("numPurchased", 15).limit(1).get()).size());
//    }
//
//    @Test
