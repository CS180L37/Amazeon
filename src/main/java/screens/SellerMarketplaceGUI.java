...
// Product productOne = new Product(1, "Air Heads", 3, "tangy, taffy-like, chewy
// candy", 4.00, 1, 1);
// Product productTwo = new Product(2, "SourPatch Kids", 5, "soft candy with a
// coating of invert sugar and sour sugar", 2.00, 2, 1);
// Product productThree = new Product(3, "Dairy Milk", 7, "smooth and creamy
// wave of deliciousness moulded into a unique chocolate taste", 5.00, 3, 1);
// Product productFour = new Product(4, "Candy Cane", 9, "cane-shaped stick
// candy", 1.00, 1, 2);
...
// sortMarketplaceMenu.show(sortMarketplaceButton, 0,
// sortMarketplaceButton.getHeight());
// }
// }
// };
...
// Container content = frame.getContentPane(); //creates a container in which
// things go for that frame
...
// middlePanel.setLayout(new GridLayout(0, 1)); // creates layout needed for a
// vertical arranagement of products in the marketplace
...
// "<div>" + "Product Name: " + storesList.get(i).getProducts().get(j).getName()
// + "</div>" +
// "<div>" + "StoreName: " + storesList.get(i).getName() + "</div>" +
// "<div>" + "Product Price: $" +
// storesList.get(i).getProducts().get(j).getPrice() + "</div>" +
// "</div>" +
// "</html>"
// );
...
=======
// content.add(scrollPane, BorderLayout.CENTER); // adds the scroll bar to the
// container
>>>>>>> 99c0b56421d1cc589ec4ecc799e336a9f73e92e9
