...
// public class SellerDashboard extends Dashboard<Customer, Product> implements
// DashboardInterface<Customer, Product> {

// public SellerDashboard() {
// super();
// }

// public SellerDashboard(ArrayList<Customer> customers, ArrayList<Product>
// products) {
...
// sortedCust.get(maxIndex).getProducts().size()) {
// maxIndex = j;
// }
// }
...
// for (Sale sale :
// Amazeon.getSellerById(getData2().get(i).getSellerId()).getSales()) {
// if (sale.getProduct().equals(product)) {
// numberSales++;
// }
// }

// System.out.println(i + ". " + getData2().get(i) + " - " + numberSales + "
// Sales");
// numberSales = 0;
// }
