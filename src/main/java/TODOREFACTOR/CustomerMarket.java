...
// public class CustomerMarket extends Market<Customer> implements
// MarketInterface<Customer, Store, Store> {
...
// Amazeon.getStoreById(allProducts.get(i).getStoreId())
...
// int maxIndex = i;
// for (int j = 0; i < allProducts.size(); j++) {
// if (allProducts.get(i).getQuantity() >
// allProducts.get(maxIndex).getQuantity()) {
// maxIndex = j;
// }
// }
// if (maxIndex != i) {
...
// for (int i = 0; i < allProducts.size(); i++) {
// System.out.println("Store Name: " +
// Amazeon.getStoreById(allProducts.get(i).getStoreId()).getName()
// + "\nProduct Name: " + allProducts.get(i).getName()
// + "\nProduct Price: " + allProducts.get(i).getPrice() + "/n/n");
// }
// }
...
// public ArrayList<Product> search(String name, String storeId, String
// description) {
...
// for (int j = 0; j < this.getStores().get(i).getProducts().size(); j++) {
// if
// (String.valueOf(this.getStores().get(i).getProducts().get(j).getStoreId()).contains(storeId))
// {
// relevantProducts.add(this.getStores().get(i).getProducts().get(j));
// }
// }
...
// for (int j = 0; j < this.getStores().get(i).getProducts().size(); j++) {
// if
// (this.getStores().get(i).getProducts().get(j).getDescription().contains(description))
// {
// relevantProducts.add(this.getStores().get(i).getProducts().get(j));
// }
// }
...
// System.out.println("Store Name: " +
// Amazeon.getStoreById(relevantProducts.get(i).getStoreId()).getName()
