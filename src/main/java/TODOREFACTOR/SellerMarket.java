...
// public class SellerMarket extends Market<Seller> implements
// MarketInterface<Seller, Customer, Product> {
// private SellerDashboard dashboard;

// public SellerMarket(Seller seller, ArrayList<Store> stores,
...
// public SellerMarket(Seller seller, ArrayList<Store> stores, SellerDashboard
// dashboard) {
// super(seller, stores);
